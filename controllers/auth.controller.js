...
exports.signUp = async(req, res, next) => {
    ...
    if(existingUser) return res.status(401).json({ message: "User with this email already exists "});
    ...
    if (!access_token) return new AppError('Error while creating access token', 500);
